...
use App\Models\MemberImageModel;
...
class MemberImageController extends Controller
{
    ...
    public function upload_picture(Request $request)
    {
        try {
            ...
            $existingImage = MemberImageModel::where('member_id', $request->member_id)->first();
            ...
            if (!$existingImage) {
                ...
                $created_image_data = MemberImageModel::create([
                ...
                $request->image->move(public_path('images/Members/'), $imageName);
                $imagePath = "/images/Members/". $imageName;
                $updated_image_data = MemberImageModel::where('member_id', $request->member_id)->update([
                    'image_name' => $imageName,
                    'image_path' => $imagePath,
                ]);
                return response()->json([
